...
--Cấp quyền cho Trưởng phòng có thể thêm, sửa, xóa quan hệ PHANCONG
...
GRANT SELECT ON QLDA.V_QLDA_NHANVIEN_NS TO TP; --View đã tạo bên cs5
...
--Trưởng phòng chỉ được phân công cho nhân viên thuộc phòng ban của mình
