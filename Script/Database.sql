...
drop table QLDA.QLDA_PHONGBAN CASCADE CONSTRAINTS;
drop table QLDA.QLDA_NHANVIEN CASCADE CONSTRAINTS;
drop table QLDA.QLDA_DEAN CASCADE CONSTRAINTS;
drop table QLDA.QLDA_PHANCONG CASCADE CONSTRAINTS;
